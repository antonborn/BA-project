...
ggplot2::qplot(rowSums(otu_table(ps.rarefied)))
ggplot2::qplot(log(rowSums(otu_table(ps))), binwidth = 0.1)
DESeq2::varianceStabilizingTransformation(otu_table(ps))
```
...
```{r}
plot_richness(ps.rarefied, x="Group", measures=c("Observed", "Shannon")) +
  geom_boxplot() +
  theme_classic() +
